...
### file%3A%2F%2F%2FUsers%2Fhalakhalifa%2FDesktop%2FbigData%2FSparkRepo%2Fsrc%2Fmain%2Fscala%2FMain.scala:134: error: `;` expected but `.` found
    val queryResult = collection.find(equal("word", "play")).results()queryResult.foreach(doc => println(doc.toJson()))
                                                                                 ^
...
scala.meta.internal.parsers.Reporter.syntaxError(Reporter.scala:16)
	...
	scala.meta.internal.parsers.ScalametaParser.iter$7(ScalametaParser.scala:4227)
